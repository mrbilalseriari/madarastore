! function (h, j, b, l, a, d) {
    ...
    function g(m, f, o, c) {
        return f && j.getElementById(f) || (c = j.createElement(m || "SCRIPT"), f && (c.id = f), o && (c.onload = o), j.head.appendChild(c)), c || {}
    }
    d = /p/.test(j.readyState), h.addEventListener("on" + b in h ? b : "load", function () {
        for (d = 1; a[0];) {
            k(a.shift(), a.shift())
        }
    }), k._ = g, h.defer = k, h.deferscript = function (m, f, o, c) {
        k(function () {
            g("", f, c)
                .src = m
        }, o)
...
, function (G, j) {
    ...
    function i(b, a) {
        return [].slice.call((a || j)
            .querySelectorAll(b))
    }
    
    function u(a) {
        return function (h, b, l, d, m, g) {
            D(function (p, e) {
                function c(s) {
                    !1 !== (d || E)
                        .call(s, s) && ((g || ["srcset", w, "style"])[f](function (v, n) {
                            (n = s[z](q + v)) && s[r](v, n)
                        }), i("SOURCE", s)[f](c), B in s && s[B]()), s.className += " " + (l || o)
                }
                e = C in G ? (p = new G[C](function (n) {
                        n[f](function (v, s) {
                            v.isIntersecting && (s = v.target) && (p.unobserve(s), c(s))
                        })
                    }, m))
                    .observe.bind(p) : c, i(h || a + "[" + q + w + "]:not([" + k + "])")[f](function (n) {
                        n[z](k) || (n[r](k, a), e(n))
                    })
            }, b)
        }
    ...
    function F() {
        D(function (b, h, a, g, c) {
            b = i((a = "[type=deferjs]") + ":not(" + (g = "[async]") + ")")
                .concat(i(a + g))
                , function d() {
                    if (0 != b) {
                        for (g in (a = b.shift())
                            .parentNode.removeChild(a), a.removeAttribute("type"), h = x(a.nodeName), a) {
                            "string" == typeof (c = a[g]) && h[g] != c && (h[g] = c)
                        }
                        h[w] && !h.hasAttribute("async") ? h.onload = h.onerror = d : D(d, 0.1)
                    }
                }()
        }, 4)
    }
    F(), G.deferstyle = function (b, d, c, a) {
        D(function (g) {
            (g = x("LINK", d, a))
            .rel = "stylesheet", g.href = b
        }, c)
    }, G.deferimg = u("IMG"), G.deferiframe = u("IFRAME"), D.all = F
}(this, document);
! function (e, t) {
    "use strict";
        ...
        , add: function (t, e, n, r, i) {
            ...
            if (V(t)) {
                n.handler && (n = (o = n)
                        ...
                        .match(P) || [""])
                    .length;
                while (l--) d = g = (s = Te.exec(e[l]) || [])[1], h = (s[2] || "")
                    .split(".")
    ...
    function Pe(n, r, i, o) {
        ...
        if (f && (t = (e = xe(r, n[0].ownerDocument, !1, n, o))
            ...
            for (s = (a = S.map(ve(e, "script"), Le))
                .length; c < f; c++) u = e, c !== p && (u = S.clone(u, !0, !0), s && S.merge(a, ve(u, "script"))), i.call(n[c], u, c);
            if (s)
                for (l = a[a.length - 1].ownerDocument, S.map(a, He), c = 0; c < s; c++) u = a[c], he.test(u.type || "") && !Y.access(u, "globalEval") && S.contains(l, u) && (u.src && "module" !== (u.type || "")
    ...
    S.extend({
        ...
        , append: function () {
            return Pe(this, arguments, function (e) {
                1 !== this.nodeType && 11 !== this.nodeType && 9 !== this.nodeType || qe(this, e)
                    .appendChild(e)
            })
        }
        , prepend: function () {
        ...
        l.style && (l.style.backgroundClip = "content-box", l.cloneNode(!0)
            .style.backgroundClip = "", y.clearCloneStyle = "content-box" === l.style.backgroundClip, S.extend(y, {
                ...
                , reliableTrDimensions: function () {
                    var e, t, n, r;
                    return null == a && (e = E.createElement("table"), t = E.createElement("tr"), n = E.createElement("div"), e.style.cssText = "position:absolute;left:-11111px", t.style.height = "1px", n.style.height = "9px", re.appendChild(e)
                        .appendChild(t)
                        .appendChild(n), r = C.getComputedStyle(t), a = 3 < parseInt(r.height), re.removeChild(e)), a
                }
            }))
    }();
    ...
    function Ze(e, t, n) {
        ...
        return (!y.boxSizingReliable() && i || !y.reliableTrDimensions() && A(e, "tr") || "auto" === a || !parseFloat(a) && "inline" === S.css(e, "display", !1, r)) && e.getClientRects()
            .length && (i = "border-box" === S.css(e, "boxSizing", !1, r), (o = s in e) && (a = e[s])), (a = parseFloat(a) || 0) + Ke(e, t, n || (i ? "border" : "content"), o, r, a) + "px"
    }
    ...
    S.extend({
            ...
            S.cssHooks[u] = {
                get: function (e, t, n) {
                    if (t) return !Ve.test(S.css(e, "display")) || e.getClientRects()
                        .length && e.getBoundingClientRect()
                        .width ? Ze(e, u, n) : We(e, Ye, function () {
                            return Ze(e, u, n)
                        })
                }
                , set: function (e, t, n) {
            ...
            if (t) return (parseFloat(Be(e, "marginLeft")) || e.getBoundingClientRect()
                .left - We(e, {
                    marginLeft: 0
                }, function () {
    ...
    function ct(e, t, n) {
        for (var r, i = (ft.tweeners[t] || [])
                .concat(ft.tweeners["*"]), o = 0, a = i.length; o < a; o++)
    ...
    S.Animation = S.extend(ft, {
        ...
        .appendChild(E.createElement("option")), rt.type = "checkbox", y.checkOn = "" !== rt.value, y.optSelected = it.selected, (rt = E.createElement("input"))
        .value = "t", rt.type = "radio", y.radioValue = "t" === rt.value;
    ...
    S.fn.extend({
        ...
        addClass: function (t) {
            ...
            if (m(t)) return this.each(function (e) {
                S(this)
                    .addClass(t.call(this, e, yt(this)))
            });
            if ((e = mt(t))
                .length)
                while (n = this[u++])
        ...
        , removeClass: function (t) {
            ...
            if (m(t)) return this.each(function (e) {
                S(this)
                    .removeClass(t.call(this, e, yt(this)))
            });
        ...
        , toggleClass: function (i, t) {
            ...
            return "boolean" == typeof t && a ? t ? this.addClass(i) : this.removeClass(i) : m(i) ? this.each(function (e) {
                S(this)
                    .toggleClass(i.call(this, e, yt(this), t), t)
            }) : this.each(function () {
                var e, t, n, r;
                if (a) {
                    t = 0, n = S(this), r = mt(i);
    ...
    S.extend(S.event, {
        trigger: function (e, t, n, r) {
            ...
            if (o = f = a = n = n || E, 3 !== n.nodeType && 8 !== n.nodeType && !bt.test(d + S.event.triggered) && (-1 < d.indexOf(".") && (d = (h = d.split("."))
    ...
    S.parseXML = function (e) {
        ...
        return t && !t.getElementsByTagName("parsererror")
            .length || S.error("Invalid XML: " + e), t
    };
    var St = /\[\]$/
        , kt = /\r?\n/g
            ...
            return this.map(function () {
                ...
                .filter(function () {
                    ...
                    return this.name && !S(this)
                        .is(":disabled") && Nt.test(this.nodeName) && !At.test(e) && (this.checked || !pe.test(e))
                })
                .map(function (e, t) {
                    var n = S(this)
                        .val();
    ...
    Wt.href = Tt.href, S.extend({
        ...
        , ajax: function (e, t) {
            ...
            if (x.promise(T), v.url = ((e || v.url || Tt.href) + "")
                .replace(Pt, Tt.protocol + "//"), v.type = t.method || t.type || v.method || v.type, v.dataTypes = (v.dataType || "*")
                .toLowerCase()
            ...
            for (i in (g = S.event && v.global) && 0 == S.active++ && S.event.trigger("ajaxStart"), v.type = v.type.toUpperCase(), v.hasContent = !Ot.test(v.type), f = v.url.replace(qt, ""), v.hasContent ? v.data && v.processData && 0 === (v.contentType || "")
                .indexOf("application/x-www-form-urlencoded") && (v.data = v.data.replace(jt, "+")) : (o = v.url.slice(f.length), v.data && (v.processData || "string" == typeof v.data) && (f += (Et.test(f) ? "&" : "?") + v.data, delete v.data), !1 === v.cache && (f = f.replace(Lt, "$1"), o = (Et.test(f) ? "&" : "?") + "_=" + Ct.guid++ + o), v.url = f + o), v.ifModified && (S.lastModified[f] && T.setRequestHeader("If-Modified-Since", S.lastModified[f]), S.etag[f] && T.setRequestHeader("If-None-Match", S.etag[f])), (v.data && v.hasContent && !1 !== v.contentType || t.contentType) && T.setRequestHeader("Content-Type", v.contentType), T.setRequestHeader("Accept", v.dataTypes[0] && v.accepts[v.dataTypes[0]] ? v.accepts[v.dataTypes[0]] + ("*" !== v.dataTypes[0] ? ", " + It + "; q=0.01" : "") : v.accepts["*"]), v.headers) T.setRequestHeader(i, v.headers[i]);
    ...
    S.ajaxSetup({
        ...
        if (a || "jsonp" === e.dataTypes[0]) return r = e.jsonpCallback = m(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Vt, "$1" + r) : !1 !== e.jsonp && (e.url += (Et.test(e.url) ? "&" : "?") + e.jsonp + "=" + r), e.converters["script json"] = function () {
            ...
            .body)
        .innerHTML = "<form></form><form></form>", 2 === Ut.childNodes.length), S.parseHTML = function (e, t, n) {
        ...
        setOffset: function (e, t, n) {
            ...
            "static" === l && (e.style.position = "relative"), s = c.offset(), o = S.css(e, "top"), u = S.css(e, "left"), ("absolute" === l || "fixed" === l) && -1 < (o + u)
                .indexOf("auto") ? (a = (r = c.position())
                    .top, i = r.left) : (a = parseFloat(o) || 0, i = parseFloat(u) || 0), m(t) && (t = t.call(e, n, S.extend({}, s))), null != t.top && (f.top = t.top - s.top + a), null != t.left && (f.left = t.left - s.left + i), "using" in t ? t.using.call(e, f) : ("number" == typeof f.top && (f.top += "px"), "number" == typeof f.left && (f.left += "px"), c.css(f))
        }
    }, S.fn.extend({
        offset: function (t) {
        ...
        S.cssHooks[n] = $e(y.pixelPosition, function (e, t) {
            if (t) return t = Be(e, n), Me.test(t) ? S(e)
                .position()[n] + "px" : t
        })
    }), S.each({
        Height: "height"
    ...
    var e = function (b) {
            this._core = b, this._loaded = [], this._handlers = {
                    "initialized.owl.carousel change.owl.carousel resized.owl.carousel": a.proxy(function (b) {
                                ...
                                FCInstagram.version = "2.7.0";
                                console.info("%c " + FCInstagram.name + " %c v" + FCInstagram.version + " %c", "margin-left: 5px; padding: 1px; color: #FEFEFE; font-size: 12px; line-height: 15px; background: #F79433; border-radius: 3px 0 0 3px;", "padding: 1px; color: #FEFEFE; font-size: 12px; line-height: 15px; background: #FF5722; border-radius: 0 3px 3px 0;", "background: transparent;");
                                if (typeof Object.create !== "function") {
                                    ...
                                    var d = {
                                        ...
                                        , initialize: function (f, g) {
                                            this.elem = g;
                                            this.$elem = c(g);
                                            (this.accessToken = c.fn.FCInstagram.accessData.accessToken), (this.options = c.extend({}, c.fn.FCInstagram.options, f));
                                            this.messages = {
                                            ...
                                            f.fetch()
                                                .done(function (g) {
                                                    if (g.data) {
                                                        ...
                                                        if (g.error.message) {
                                                            c.error("FCInstagram.js - Error: " + g.error.message)
                                                        } else {
                                                            c.error("FCInstagram.js - Error: user does not have photos.")
                                                        }
                                                    }
                                                })
                                        }
                                        , fetch: function () {
                                            var f = this.API_URL + this.API_FIELDS + "&access_token=" + this.accessToken;
                                            return c.ajax({
                                                type: "GET"
                                                , dataType: "jsonp"
                                                , cache: false
                                        ...
                                        , displayPhotos: function (l) {
                                            var o, f, m, k = []
                                                , h, g, n;
                                            n = this.options.max >= l.data.length ? l.data.length : this.options.max;
                                            if (l.data === e || l.data.length === 0) {
                                                this.$elem.append(this.messages.notFound);
                                                return
                                            }
                                            for (var j = 0; j < n; j++) {
                                                if (l.data[j].media_type === "IMAGE" || l.data[j].media_type === "CAROUSEL_ALBUM") {
                                                    m = l.data[j].caption !== null || l.data[j].caption !== e;
                                                    h = m ? c("<span>")
                                                        .text(l.data[j].caption)
                                                        .html() : this.messages.defaultImageAltText;
                                                    o = c("<a>", {
                                                        href: l.data[j].permalink
                                                        , target: "_blank"
                                                        , title: h
                                                        , style: "background:url(" + l.data[j].media_url + ") no-repeat center / cover;"
                                                        , rel: "noopener"
                                                    });
                                                    k.push(o)
                                                } else {
                                                    if (l.data[j].media_type === "VIDEO") {
                                                        g = this.options.autoplay == true ? "autoplay muted loop playsinline" : "";
                                                        $source = c("<source>", {
                                                            src: l.data[j].media_url
                                                            , type: "video/mp4"
                                                        });
                                                        f = c("<video " + g + ">")
                                                            .append($source);
                                    ...
                                    jQuery.fn.FCInstagram = function (f) {
                                        if (jQuery.fn.FCInstagram.accessData.accessToken) {
                                            ...
                                            c.error("You must define an accessToken on jQuery.FCInstagram")
                                        }
                                    };
